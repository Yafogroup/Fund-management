    ...
    return (
        <Card className="p-6 bg-dark bg-sidebar mt-10">
            ...
            <Dialog open={editModalOpen} handler={() => setEditModalOpen(false)} size="md"
                ...
                <div className="flex justify-between items-center px-4 pt-4">
                    <DialogHeader className="text-white">{selectedEvent ? "Edit Event" : "Create Event"}</DialogHeader>
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleSubmit} className="ml-2 bg-gradient-to-tr from-[#0023af] via-[#006ec1] to-[#00a0ce]">
